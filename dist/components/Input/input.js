...
export var Input = function (props) {
    ...
    var cnames = classNames('rock-input-wrapper', (_a = {},
    ...
    return (React.createElement("div", { className: cnames, style: style },
        prepend && React.createElement("div", { className: "rock-input-group-prepend" }, prepend),
        ...
        append && React.createElement("div", { className: "rock-input-group-append" }, append)));
};
